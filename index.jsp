                    ...
                    <nav class="nav put-right">
                        <ul class="sf-menu">
                          ...
                          <!--  <li>
                            ...
                            <li><a href="wheretostudy.jsp">Where to Study</a></li>
            ...
            <div class="grid_12">
                <div id="owl">
                    ...
                    <%
                        ...
                        ResultSet rs = st.executeQuery("select * from university order by ranking asc ");
                    ...
                    <div class="item">
                        <p class="text_3">
                          <center>    
                        <table  border="50" width="1000" bgcolor="lightgreen">
                    <tr style="color:red;" >
                        <th>University Name</th>
